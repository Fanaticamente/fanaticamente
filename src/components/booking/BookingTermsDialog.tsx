    ...
    <div className="bg-white rounded-2xl p-4 mb-6 shadow-sm border" style={{ borderColor: clubColor + "30" }}>
      ...
      >
        ...
        <p className="text-sm leading-relaxed" style={{ color: clubColor }}>
          Li e aceito os <TermsLink />. Declaro estar ciente de que os pagamentos são realizados diretamente ao profissional e que a Fanaticamente atua apenas como uma plataforma de conexão.
        </p>
      </label>
    </div>
  );
