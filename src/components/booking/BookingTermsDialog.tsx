    ...
    <div className="bg-white rounded-2xl p-5 mb-6 shadow-sm border" style={{ borderColor: clubColor + "30" }}>
      <div className="flex items-start gap-3">
        <Checkbox
          ...
          className="mt-1 border-2 flex-shrink-0 h-5 w-5"
          style={{ 
        ...
        <label htmlFor="booking-terms" className="text-sm cursor-pointer leading-relaxed" style={{ color: clubColor }}>
          ...
          </Dialog>. Declaro estar ciente de que os pagamentos são realizados diretamente ao profissional e que a Fanaticamente atua apenas como uma plataforma de conexão.
        </label>
      </div>
    </div>
  );
