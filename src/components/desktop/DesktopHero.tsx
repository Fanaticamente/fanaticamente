      ...
      <div className="bg-white py-24">
        <div className="max-w-7xl mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-center">
            ...
            <div>
              <h2 className="font-display text-4xl lg:text-5xl xl:text-[56px] text-black font-bold leading-[1.1]">
            ...
            <div className="bg-[#f5f5f5] rounded-lg p-8 lg:p-10">
              ...
              <p className="text-base lg:text-lg text-black leading-relaxed">
                No aplicativo <span className="font-bold">Fanaticamente</span>, cada um tem seu clube do coração, mas quando o assunto é saúde mental, todos jogam no <span className="font-bold">mesmo time</span>!
              </p>
            </div>
          </div>
        </div>
