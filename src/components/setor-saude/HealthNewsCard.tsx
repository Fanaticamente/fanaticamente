          ...
          <div className="bg-white rounded-2xl overflow-hidden relative group shadow-sm">
            {news.cover_image_url && (
              <div className="relative h-48 overflow-hidden">
                ...
                <span className="absolute top-3 left-3 px-3 py-1 bg-gray-900 text-white text-xs font-bold rounded-full uppercase flex items-center gap-1">
            ...
            <div className="p-4">
              ...
              <div className="flex items-center justify-between text-xs text-gray-500">
                <span className="font-medium text-gray-700">Fanaticamente</span>
      ...
      >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="flex items-center gap-2 text-xs text-gray-500 whitespace-nowrap overflow-hidden">
            <span className="px-2 py-0.5 bg-gray-100 text-gray-700 rounded truncate">{news.category}</span>
        ...
        <ChevronRight className="w-5 h-5 text-gray-500 group-hover:translate-x-1 transition-transform flex-shrink-0" />
      </button>
      <HealthNewsReader news={news} isOpen={isOpen} onClose={close} />
    </>
  );
