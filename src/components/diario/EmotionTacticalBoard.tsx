...
const formations: Formation[] = [
  {
    ...
    slots: [
      ...
      { id: "d1", x: 14, y: 72, sector: "defesa" },
      { id: "d2", x: 38, y: 72, sector: "defesa" },
      { id: "d3", x: 62, y: 72, sector: "defesa" },
      { id: "d4", x: 86, y: 72, sector: "defesa" },
      { id: "m1", x: 18, y: 50, sector: "meio_campo" },
      { id: "m2", x: 50, y: 54, sector: "meio_campo" },
      { id: "m3", x: 82, y: 50, sector: "meio_campo" },
      { id: "a1", x: 16, y: 22, sector: "ataque" },
      { id: "a2", x: 50, y: 26, sector: "ataque" },
      { id: "a3", x: 84, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 88, sector: "defesa" },
      { id: "d1", x: 22, y: 72, sector: "defesa" },
      { id: "d2", x: 50, y: 72, sector: "defesa" },
      { id: "d3", x: 78, y: 72, sector: "defesa" },
      { id: "m1", x: 14, y: 50, sector: "meio_campo" },
      { id: "m2", x: 38, y: 46, sector: "meio_campo" },
      { id: "m3", x: 62, y: 46, sector: "meio_campo" },
      { id: "m4", x: 86, y: 50, sector: "meio_campo" },
      { id: "a1", x: 16, y: 24, sector: "ataque" },
      { id: "a2", x: 50, y: 20, sector: "ataque" },
      { id: "a3", x: 84, y: 24, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d2", x: 50, y: 72, sector: "defesa" },
      { id: "d3", x: 78, y: 72, sector: "defesa" },
      { id: "m1", x: 12, y: 48, sector: "meio_campo" },
      { id: "m2", x: 31, y: 44, sector: "meio_campo" },
      { id: "m3", x: 50, y: 54, sector: "meio_campo" },
      { id: "m4", x: 69, y: 44, sector: "meio_campo" },
      { id: "m5", x: 88, y: 48, sector: "meio_campo" },
      { id: "a1", x: 28, y: 22, sector: "ataque" },
      { id: "a2", x: 72, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "m2", x: 31, y: 46, sector: "meio_campo" },
      { id: "m3", x: 50, y: 42, sector: "meio_campo" },
      { id: "m4", x: 69, y: 46, sector: "meio_campo" },
      { id: "m5", x: 88, y: 50, sector: "meio_campo" },
  ...
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 88, sector: "defesa" },
      { id: "d1", x: 12, y: 68, sector: "defesa" },
      { id: "d2", x: 31, y: 74, sector: "defesa" },
      { id: "d3", x: 50, y: 74, sector: "defesa" },
      { id: "d4", x: 69, y: 74, sector: "defesa" },
      { id: "d5", x: 88, y: 68, sector: "defesa" },
      { id: "m1", x: 22, y: 48, sector: "meio_campo" },
      { id: "m2", x: 42, y: 44, sector: "meio_campo" },
      { id: "m3", x: 58, y: 44, sector: "meio_campo" },
      { id: "m4", x: 78, y: 48, sector: "meio_campo" },
      { id: "ca", x: 50, y: 18, sector: "centroavante" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d3", x: 62, y: 72, sector: "defesa" },
      { id: "d4", x: 86, y: 72, sector: "defesa" },
      { id: "m1", x: 36, y: 56, sector: "meio_campo" },
      { id: "m2", x: 64, y: 56, sector: "meio_campo" },
      { id: "a1", x: 16, y: 34, sector: "ataque" },
      { id: "a2", x: 50, y: 38, sector: "ataque" },
      { id: "a3", x: 84, y: 34, sector: "ataque" },
