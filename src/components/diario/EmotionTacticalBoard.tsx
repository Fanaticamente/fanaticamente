...
const formations: Formation[] = [
  {
    ...
    slots: [
      ...
      { id: "m1", x: 28, y: 50, sector: "meio_campo" },
      { id: "m2", x: 50, y: 54, sector: "meio_campo" },
      { id: "m3", x: 72, y: 50, sector: "meio_campo" },
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "d3", x: 78, y: 72, sector: "defesa" },
      { id: "m1", x: 14, y: 50, sector: "meio_campo" },
      { id: "m2", x: 32, y: 44, sector: "meio_campo" },
      { id: "m3", x: 50, y: 54, sector: "meio_campo" },
      { id: "m4", x: 68, y: 44, sector: "meio_campo" },
      { id: "m5", x: 86, y: 50, sector: "meio_campo" },
      { id: "a1", x: 34, y: 22, sector: "ataque" },
      { id: "a2", x: 66, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d4", x: 86, y: 72, sector: "defesa" },
      { id: "m1", x: 14, y: 50, sector: "meio_campo" },
      { id: "m2", x: 32, y: 46, sector: "meio_campo" },
      { id: "m3", x: 50, y: 42, sector: "meio_campo" },
      { id: "m4", x: 68, y: 46, sector: "meio_campo" },
      { id: "m5", x: 86, y: 50, sector: "meio_campo" },
  ...
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 88, sector: "defesa" },
      { id: "d1", x: 14, y: 68, sector: "defesa" },
      { id: "d2", x: 32, y: 74, sector: "defesa" },
      { id: "d3", x: 50, y: 74, sector: "defesa" },
      { id: "d4", x: 68, y: 74, sector: "defesa" },
      { id: "d5", x: 86, y: 68, sector: "defesa" },
      { id: "m1", x: 16, y: 48, sector: "meio_campo" },
      { id: "m2", x: 38, y: 44, sector: "meio_campo" },
      { id: "m3", x: 62, y: 44, sector: "meio_campo" },
      { id: "m4", x: 84, y: 48, sector: "meio_campo" },
      { id: "ca", x: 50, y: 20, sector: "centroavante" },
    ],
  },
  {
