...
const formations: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { id: "d1", x: 22, y: 78, sector: "defesa" },
      { id: "d2", x: 50, y: 78, sector: "defesa" },
      { id: "d3", x: 78, y: 78, sector: "defesa" },
      { id: "m3", x: 50, y: 64, sector: "meio_campo" },
      { id: "m2", x: 32, y: 55, sector: "meio_campo" },
      { id: "m4", x: 68, y: 55, sector: "meio_campo" },
      { id: "m1", x: 12, y: 46, sector: "meio_campo" },
      { id: "m5", x: 88, y: 46, sector: "meio_campo" },
      { id: "a1", x: 32, y: 22, sector: "ataque" },
      { id: "a2", x: 68, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d2", x: 36, y: 78, sector: "defesa" },
      { id: "d3", x: 64, y: 78, sector: "defesa" },
      { id: "d4", x: 90, y: 76, sector: "defesa" },
      { id: "m3", x: 50, y: 64, sector: "meio_campo" },
      { id: "m2", x: 32, y: 56, sector: "meio_campo" },
      { id: "m4", x: 68, y: 56, sector: "meio_campo" },
      { id: "m1", x: 12, y: 46, sector: "meio_campo" },
      { id: "m5", x: 88, y: 46, sector: "meio_campo" },
  ...
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 92, sector: "defesa" },
      { id: "d1", x: 10, y: 68, sector: "defesa" },
      { id: "d5", x: 90, y: 68, sector: "defesa" },
      { id: "d2", x: 28, y: 80, sector: "defesa" },
      { id: "d3", x: 50, y: 80, sector: "defesa" },
      { id: "d4", x: 72, y: 80, sector: "defesa" },
      { id: "m2", x: 36, y: 56, sector: "meio_campo" },
      { id: "m3", x: 64, y: 56, sector: "meio_campo" },
      { id: "m1", x: 12, y: 46, sector: "meio_campo" },
      { id: "m4", x: 88, y: 46, sector: "meio_campo" },
      { id: "ca", x: 50, y: 20, sector: "centroavante" },
    ],
  },
  {
