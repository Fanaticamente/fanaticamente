...
const formations: Formation[] = [
  {
    ...
    slots: [
      ...
      { id: "d2", x: 37, y: 70, sector: "defesa" },
      { id: "d3", x: 63, y: 70, sector: "defesa" },
      { id: "d4", x: 86, y: 68, sector: "defesa" },
      { id: "m1", x: 22, y: 46, sector: "meio_campo" },
      { id: "m2", x: 50, y: 49, sector: "meio_campo" },
      { id: "m3", x: 78, y: 46, sector: "meio_campo" },
      { id: "a1", x: 18, y: 22, sector: "ataque" },
      { id: "a2", x: 50, y: 18, sector: "ataque" },
      { id: "a3", x: 82, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 90, sector: "defesa" },
      { id: "d1", x: 22, y: 70, sector: "defesa" },
      { id: "d2", x: 50, y: 72, sector: "defesa" },
      { id: "d3", x: 78, y: 70, sector: "defesa" },
      { id: "m1", x: 14, y: 46, sector: "meio_campo" },
      { id: "m2", x: 37, y: 49, sector: "meio_campo" },
      { id: "m3", x: 63, y: 49, sector: "meio_campo" },
      { id: "m4", x: 86, y: 46, sector: "meio_campo" },
      { id: "a1", x: 18, y: 22, sector: "ataque" },
      { id: "a2", x: 50, y: 18, sector: "ataque" },
      { id: "a3", x: 82, y: 22, sector: "ataque" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d2", x: 50, y: 72, sector: "defesa" },
      { id: "d3", x: 78, y: 70, sector: "defesa" },
      { id: "m1", x: 13, y: 46, sector: "meio_campo" },
      { id: "m2", x: 30, y: 49, sector: "meio_campo" },
      { id: "m3", x: 50, y: 44, sector: "meio_campo" },
      { id: "m4", x: 70, y: 49, sector: "meio_campo" },
      { id: "m5", x: 87, y: 46, sector: "meio_campo" },
      { id: "a1", x: 35, y: 19, sector: "ataque" },
      { id: "a2", x: 65, y: 19, sector: "ataque" },
    ],
  },
  {
  ...
  },
  {
    ...
    slots: [
      { id: "gk", x: 50, y: 90, sector: "defesa" },
      { id: "d1", x: 11, y: 68, sector: "defesa" },
      { id: "d2", x: 30, y: 70, sector: "defesa" },
      { id: "d3", x: 50, y: 72, sector: "defesa" },
      { id: "d4", x: 70, y: 70, sector: "defesa" },
      { id: "d5", x: 89, y: 68, sector: "defesa" },
      { id: "m1", x: 16, y: 46, sector: "meio_campo" },
      { id: "m2", x: 38, y: 49, sector: "meio_campo" },
      { id: "m3", x: 62, y: 49, sector: "meio_campo" },
      { id: "m4", x: 84, y: 46, sector: "meio_campo" },
      { id: "ca", x: 50, y: 18, sector: "centroavante" },
    ],
  },
  {
    ...
    slots: [
      ...
      { id: "d3", x: 63, y: 70, sector: "defesa" },
      { id: "d4", x: 86, y: 68, sector: "defesa" },
      { id: "m1", x: 35, y: 50, sector: "meio_campo" },
      { id: "m2", x: 65, y: 50, sector: "meio_campo" },
      { id: "a1", x: 18, y: 32, sector: "ataque" },
      { id: "a2", x: 50, y: 30, sector: "ataque" },
      { id: "a3", x: 82, y: 32, sector: "ataque" },
      { id: "ca", x: 50, y: 14, sector: "centroavante" },
    ],
  },
];
